...
public class EmployeeController {
    ...
    @Operation(summary = "Get employees by status",
               description = "Valid statuses: ACTIVE, ON_LEAVE, TERMINATED")
    ...
    @Operation(summary = "Search employees",
               description = "Full-text search across first name, last name, and email. Supports pagination and sorting.")
    @GetMapping("/search")
    ...
    public ResponseEntity<List<EmployeeResponse>> getBySalaryRange(
    ...
    public ResponseEntity<List<EmployeeResponse>> getHiredInYear(
    ...
    @Operation(summary = "Update employee status (partial update)",
               description = "Valid statuses: ACTIVE, ON_LEAVE, TERMINATED")
    @PatchMapping("/{id}/status")
    public ResponseEntity<EmployeeResponse> updateStatus(
            @PathVariable Long id,
            @RequestBody Map<String, String> body) {
        EmployeeStatus status = EmployeeStatus.valueOf(
                body.getOrDefault("status", "ACTIVE").toUpperCase());
    ...
    public ResponseEntity<Map<String, Object>> applyRaise(
        ...
        return ResponseEntity.ok(Map.of(
                ...
                "employeesUpdated",  count,
                "message",           "Salary raise applied successfully"));
    }
