...
//		LOG.info(id.toString() + " will be searched.");
////		LOG.warn(id.toString() + " will be searched.");
////		LOG.debug(id.toString() + " will be searched.");
////		LOG.error(id.toString() + " will be searched.");
//
...
//	@ApiResponses({ @ApiResponse(responseCode = "201", description = "Department created"),
...
//	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Department updated"),
//			@ApiResponse(responseCode = "404", description = "Department not found"),
...
//	// ── DELETE ────────────────────────────────────────────────────────────────
//
//	@Operation(summary = "Delete a department", description = "Fails if the department has employees. Reassign employees first.")
//	@ApiResponses({ @ApiResponse(responseCode = "204", description = "Department deleted"),
